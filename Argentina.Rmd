...
```{r letRec, , echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='100%' }
  totalesProv <- casos_pronvinciales %>%  filter(departamento=="TOTAL GENERAL") %>%  select(provincia, cantidad, recuperados, fallecidos)
  ...
  # totalesProv$porcRec/totalesProv$porcFall
  ...
  fig <- plot_ly(totalesProv, x = ~porcFall, y = ~porcRec, text = ~provincia, 
                 color = ~provincia,
                 type = 'scatter', mode = 'markers',
        marker = list(size= ~porcAct, opacity = 0.5))
