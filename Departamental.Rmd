...
```{r, cargaD, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
  ...
  # covid19casos <- read_csv("https://github.com/CSSEGISandData/COVID-19/raw/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_confirmed_global.csv")
  # deptosPob <- st_read(dsn ="data/mapas/DeptosPoblacion.shp") 
  
  # covid19casos <- read_excel("data/covid19casos.xlsx")
 covid19casos <- read_csv("data/Covid19Casos.csv")
 # covid19casos <- read_csv("data/Covid19Casos_10082020.csv")
...
## Con datos abiertos de Nación
  ...
  deptal <- covid19casos %>%  filter(residencia_provincia_nombre==carga_provincia_nombre) %>% #  & sepi_apertura <= 18 ) %>% 
                  select(fecha_apertura,fecha_inicio_sintomas,  fecha_diagnostico,
                         residencia_provincia_nombre, residencia_departamento_nombre,
                         edad, edad_anos_meses, sexo, fecha_internacion, cuidado_intensivo, fecha_cui_intensivo,
                         asistencia_respiratoria_mecanica, fallecido, fecha_fallecimiento, origen_financiamiento, 
                         clasificacion_resumen, clasificacion) 
  
  deptal$residencia_provincia_nombre <- if_else(deptal$residencia_provincia_nombre=="Tierra del Fuego",
                                                "Tierra del Fuego, Antártida e Islas del Atlántico Sur",
                                                as.character(deptal$residencia_provincia_nombre))
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Salta" &  
                                                     deptal$residencia_departamento_nombre=="Grl. José de San Martín",
                                                   "General José de San Martín", deptal$residencia_departamento_nombre)
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Chaco" &  
                                                     deptal$residencia_departamento_nombre=="1º de Mayo",
                                                   "1ro. de Mayo", deptal$residencia_departamento_nombre)
  
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Formosa" &  
                                                     deptal$residencia_departamento_nombre=="Laishi",
                                                   "Laishí", deptal$residencia_departamento_nombre)
  
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Misiones" &  
                                                     deptal$residencia_departamento_nombre=="Libertador Grl. San Martín",
                                                   "Libertador General San Martín", deptal$residencia_departamento_nombre)
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Misiones" &  
                                                     deptal$residencia_departamento_nombre=="25 de Mayo",
                                                   "25de Mayo", deptal$residencia_departamento_nombre)
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Santiago del Estero" &  
                                                     deptal$residencia_departamento_nombre=="Silípica",
                                                   "Silipica", deptal$residencia_departamento_nombre)
    
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="La Rioja" &  
                                                     deptal$residencia_departamento_nombre=="San Blas de los Sauces",
                                                   "San Blas de Los Sauces", deptal$residencia_departamento_nombre)

  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="San Juan" &  
                                                     deptal$residencia_departamento_nombre=="Jáchal",
                                                   "Jachal", deptal$residencia_departamento_nombre)
  
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="San Juan" &  
                                                     deptal$residencia_departamento_nombre=="Ullúm",
                                                   "Ullum", deptal$residencia_departamento_nombre)

  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Mendoza" &  
                                                     deptal$residencia_departamento_nombre=="Luján de Cuyo",
                                                   "Cuyo", deptal$residencia_departamento_nombre)
  deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="San Luis" &  
                                                     deptal$residencia_departamento_nombre=="Luján de Cuyo",
                                                   "Cuyo", deptal$residencia_departamento_nombre)
  
 deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Neuquén" &  
                                                     deptal$residencia_departamento_nombre=="Ñorquín",
                                                   "?orquín", deptal$residencia_departamento_nombre)    
  
 deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Río Negro" &  
                                                     deptal$residencia_departamento_nombre=="Ñorquín",
                                                   "?orquín", deptal$residencia_departamento_nombre)  
 
 deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Río Negro" &  
                                                     deptal$residencia_departamento_nombre=="9 de Julio",
                                                   "9 de julio", deptal$residencia_departamento_nombre)  
 
 deptal$residencia_departamento_nombre <- if_else(deptal$residencia_provincia_nombre=="Río Negro" &  
                                                     deptal$residencia_departamento_nombre=="Ñorquincó",
                                                   "?orquinco", deptal$residencia_departamento_nombre)  
 


 # sal <- deptal %>% filter(residencia_provincia_nombre=="Río Negro")
 # table(sal$residencia_departamento_nombre)
  ...
  Tdeptal <- deptal %>% 
          group_by(residencia_provincia_nombre, residencia_departamento_nombre, clasificacion_resumen) %>%
          mutate(cantidad= n()) %>%
          select(residencia_provincia_nombre, residencia_departamento_nombre, clasificacion_resumen, cantidad) %>% 
