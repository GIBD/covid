...
```{r, cargaD, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
  ...
  deptal28 <- covid19casos %>% filter(clasificacion_resumen=="Confirmado" &
                                        ...
                                        fecha_apertura >= today()- 29 & fecha_apertura < today()- 15 ) %>% 
...
Se muestra el indicador de riesgo de cada departamento basado en la Incidencia acumulada en 14 días cada 100000 habitantes y en la razón de crecimiento de casos en los últimos 14 días.
