...
```{r, cargaD}
 ...
 ## Dataset Provincias Argentinas
 {
   ...
   names(casos_pronvinciales) <- c("provincia", "departamento",  "localidad","fecha","cantidad", "recuperados",
                                   "fallecidos", "internados", "uti", "enestudio", "aislados", "estudiados",
                                   "descartados")
 }
...
```{r dptoArg, echo=FALSE, message=FALSE, warning=FALSE}
  ...
  leaflet(data = deptos_covid) %>% setView(zoom = 1) %>% 
