...
deptal <- covid19casos %>% select(fecha_apertura,fecha_inicio_sintomas,  fecha_diagnostico,
                                   residencia_provincia_nombre, residencia_departamento_nombre,
                                  edad, edad_anos_meses, sexo,
                                  fecha_internacion, cuidado_intensivo, fecha_cui_intensivo, asistencia_respiratoria_mecanica,
   ...
   # table(covid19casos$Clasificacion)
