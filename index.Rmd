...
```{r evolArg, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
 ...
 names(argCov) <- c("dia", "casosD", "Detectados", "muertesD", "Fallecidos", "Recuperados", "UTI","MuestraD","TotalPruebas", "Descartados", "Mujeres", "Hombres", "Importados", "Estrecho", "Comunitaria", "Investigacion")
 ...
 pal <- c( '#8DA0CB', '#9BD92F','#FF8080',  '#66C2A5') 
  ...
  plot_ly(evolArg, x =~dia, y=~cantidad, split = ~tipo, color=~tipo,
         colors=pal,
         alpha = 0.1,
