  ...
  ## Dataset Provincias Argentinas
    {
      ...
      ### RIO NEGRO
      {
        ...
        rio_negro_c <- read_delim("data/rionegro_gral.csv",";", locale = locale(encoding = "ISO-8859-1"))
      ...
      {## Hoja de Planilla Excel compartida por Mapache
         ...
         neuquen_c <- read_delim("data/neuquen_gral.csv",  ";", escape_double = FALSE, 
                             locale = locale(encoding = "ISO-8859-1"), trim_ws = TRUE)
        ...
        neuquen_c <- neuquen_c %>% select(Prov, casos) 
        neuquen_c$provincia <- "Neuquén"
...
```{r test, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='100%'}
  ...
  test <- argCov %>% select(dia, DescTest, Detectados, Recuperados) %>%
