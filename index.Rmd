...
```{r setup, include=FALSE}
  ...
  paises_ameria <- read_csv("data/latinoamerica.csv")
  
    # Paises América
    paises_sa <- c('Brazil', 'Argentina', 'Chile', 'Peru', 'Paraguay', 'Bolivia', 'Uruguay', 'Colombia', 'Venezuela',  'Ecuador', 'Guayana Francesa', 'Mexico')
...
En el siguiente gráfico se puede analizar la velocidad y magnitud que ha tenido la propagación del Covid-19 en diferentes países hasta la fecha indicada. El hecho de que la visión de éste sea logarítmica permite analizar en una escala más adecuada cómo ha sido la evolución de la pandemia. 
...
```{r dinamico, echo=FALSE, fig.align='center', fig.show='animate', message=FALSE, warning=FALSE, paged.print=FALSE}
	...
	dinamico <- ggplot(avance) +
	  geom_line(aes(casos, semanal, group=pais, color=pais), size=1.1)+ scale_y_log10() + scale_x_log10() 
