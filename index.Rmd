  ...
  ## Dataset Provincias Argentinas
    {
      ...
      ### CHACO
      {
        ...
        ### SALTA
      {
        salta_c <- read_delim("data/salta_gral.csv", ";",
                          escape_double = FALSE, locale = locale(encoding = "ISO-8859-1"),
                          trim_ws = TRUE)
        salta_c <- salta_c %>% select(Localidad, casos)
        salta_c$provincia <- "Salta"
        names(salta_c) <- c( "localidad", "cantidad", "provincia")
      }
      casos_pronvinciales <- rbind.data.frame(entre_rios_c, rio_negro_c,
                                              caba_c, bsas_c, stafe_c,
                                              neuquen_c, cordoba_c,
                                              tucuman_c, chaco_c, salta_c)
      rm(entre_rios_c, rio_negro_c,caba_c, bsas_c, stafe_c,neuquen_c, cordoba_c, tucuman_c, salta_c)
...
```{r dptoArg,echo=FALSE, message=FALSE, warning=FALSE }
  ...
  #                   labels= c("1-25", "25-50", "50-100", "100-500", "500 o más"),
