...
```{r ev_prov, echo=FALSE, fig.align='center', message=FALSE, warning=FALSE, out.width='100%'}
  ...
  # h <- ggplot(tabla_prov, aes(fecha, cant, color=tipo, group=tipo, text = paste0(tipo, ": ", cant))) +
  #   geom_line(aes(shape=tipo, color=tipo)) +
  #   labs(x = 'día', y="") + 
  #   facet_wrap(~provincia, ncol=3)+   theme(legend.position = 'bottom')
  # 
  # plot_ly(data = tabla_prov, x=~fecha, y=~cant, color = ~tipo, alpha = 0.1, type='scatter', mode='lines', fill='tozeroy')
  # 
  # 
