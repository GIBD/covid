...
# class()
 ...
 evolArg %>% ggplot(aes(x=dia, y=cantidad, color = tipo)) +
   geom_area() +
   # scale_fill_manual(values=c("#0a70ad","#00bf7d",'#f54b41'),
   #                   breaks=c("Detectados", "Fallecidos", "Recuperados"))+
   labs(title='Evolución de COVID en Argentina') + labs(x = 'Día', y = "Casos") 
