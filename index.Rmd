  ...
  ## Dataset Provincias Argentinas
    {
      ...
      ### TUCUMAN
        ...
        #  names(entre_rios_c) <- c( "localidad", "cantidad", "provincia")
        #  names(caba_c) <- c( "localidad", "cantidad", "provincia")
        #  names(bsas_c) <- c( "localidad", "cantidad", "provincia")
        #  names(stafe_c) <- c( "localidad", "cantidad", "provincia")
        #  names(rio_negro_c) <- c( "localidad", "cantidad", "provincia")
        #  names(cordoba_c) <- c( "localidad", "cantidad", "provincia")
